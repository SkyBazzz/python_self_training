...
def get_rates(city="lvov", currency="usd", rate_date=datetime.now()):
    ...
    response = requests.get(
        f"https://minfin.com.ua/ua/currency/{city}/{currency}/{today}/"
    )
    text = response.text
    ...
    with open("/Users/obalkash/PycharmProjects/python_self_training/fun/exchange_rate/lviv_exchange_rate.txt", mode="a") as rates:
